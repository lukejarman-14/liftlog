...
import { Trash2, Clock, TrendingUp, ChevronDown, ChevronUp, Activity, Zap, BarChart2, ArrowUpRight, ArrowDownRight, Minus, Moon, Battery, Brain, HeartPulse, Heart } from 'lucide-react';
...
function RecoveryTab() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <MetricLineChart title="HRV"   icon={Activity} unit=" ms"  color="#7c3aed" log={dailyReadinessLog} getVal={e => e.hrvMs} />
      <MetricLineChart title="Sleep" icon={Moon}     unit=" h"   color="#2563eb" log={dailyReadinessLog} getVal={e => e.sleepHours} decimals={1} />
      <MetricLineChart title="Resting Heart Rate" icon={Heart} unit=" bpm" color="#dc2626" log={dailyReadinessLog} getVal={e => e.restingHr} />
    </div>
  );
}
