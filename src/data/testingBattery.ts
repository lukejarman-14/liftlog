...
export const TEST_PROTOCOLS = {
  ...
  yoyo: {
    ...
    whatItMeasures: 'Aerobic capacity specific to intermittent exercise — the best available predictor of football match distance covered.',
    setup: 'Two lines 20m apart. A beep track (freely available online). Run 20m shuttles in time with the beep; 10 s rest between stages. Test ends when you miss the line twice.',
    protocol: [
      'The beep audio file cues each 20m shuttle and accelerates over time.',
      'Each stage has a number and shuttle count (e.g. Level 17, shuttle 3).',
      'Stop when you fail to reach the far line before the beep twice in a row.',
      'Record the last COMPLETED level and shuttle (e.g., "17.3").',
    ],
