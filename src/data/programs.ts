...
export const FOOTBALL_PROGRAMS: Program[] = [
  {
    ...
    description: '3 simple football S&C workouts per week. Built with the same structure as Build My Programme, but generic: explosive intent, main strength, support work, core, then conditioning.',
    sport: 'football',
    templates: [
      {
        id: 'fb-weekly-session1',
        name: 'Workout 1 — Lower Strength',
        description: 'A simple lower-body football session: acceleration primer, squat and hinge strength, core, then repeated sprints.',
        program: 'Footballer Weekly Sessions',
        exercises: [
          ex('sprint',          4, 1,  0,  180, '⚡ Speed Primer'),
          ex('squat',           4, 6,  80, 240, '💪 Main Strength'),
          ex('rdl',             3, 8,  65, 180),
          ex('hip-thrust',      3, 10, 75, 120, '🦵 Support Work'),
          ex('plank',           3, 30, 0,  60,  '🧱 Core'),
          ex('repeated-sprint', 6, 1,  0,  30,  '🏃 Conditioning'),
        ],
      },
      {
        id: 'fb-weekly-session2',
        name: 'Workout 2 — Upper Strength',
        description: 'A simple upper-body football session: push, pull, shoulders, trunk stability, then interval conditioning.',
        program: 'Footballer Weekly Sessions',
        exercises: [
          ex('bench-press', 4, 6,  65, 180, '💪 Main Strength'),
          ex('barbell-row', 4, 8,  55, 150),
          ex('ohp',         3, 8,  40, 150, '🦵 Support Work'),
          ex('pull-up',     3, 8,  0,  120),
          ex('side-plank',  3, 30, 0,  60,  '🧱 Core'),
          ex('hiit-run',    8, 1,  0,  30,  '🏃 Conditioning'),
        ],
      },
      {
        id: 'fb-weekly-session3',
        name: 'Workout 3 — Full Body Power',
        description: 'A simple full-body football session: explosive primer, full-body strength, core, then shuttle conditioning.',
        program: 'Footballer Weekly Sessions',
        exercises: [
          ex('broad-jump',        4, 5,  0,  120, '⚡ Power Primer'),
          ex('deadlift',          3, 5,  95, 240, '💪 Main Strength'),
          ex('front-squat',       3, 6,  60, 180),
          ex('cable-row',         3, 10, 45, 120, '🦵 Support Work'),
          ex('hanging-leg-raise', 3, 10, 0,  60,  '🧱 Core'),
