...
export const EXERCISE_DESCRIPTIONS: Record<string, ExerciseDescription> = {
  ...
  'power-clean': {
    how: [
      'Set up like a deadlift: bar over mid-foot, hips above knees, shoulders above hips.',
      'First pull: drive the bar off the floor maintaining the back angle.',
      'Second pull: as the bar passes the knee, drive your hips into the bar explosively (the "jump" position).',
      'Receive: drop under the bar into a partial squat (quarter squat), catching it in the front rack position.',
      'Stand tall to complete.',
    ],
    tips: ['Keep the bar close to your body throughout. "Bar path" should be nearly vertical.'],
    footballContext: 'Power clean develops explosive hip extension — the same pattern used in jumping, sprinting, and kicking.',
  },
  'hang-power-clean': {
    how: [
      'Start with the bar at hip height (hang position).',
      'Hinge slightly at the hips, then explosively extend to drive the bar up.',
      'Receive the bar in the front rack in a partial squat.',
      'Stand to finish.',
    ],
    tips: ['Good starting point for learning the clean without the floor pull.'],
  },
  'squat-clean': {
    how: [
      'Same first and second pull as the power clean.',
      'Instead of catching in a partial squat, drop into a full squat under the bar.',
      'Stand up from the squat to complete the lift.',
    ],
    tips: ['Requires significant thoracic mobility and front rack flexibility.'],
  },
  'hang-clean': {
    how: [
      'Begin with the bar at hip or knee height.',
      'Same explosive hip drive as hang power clean.',
      'Receive the bar in a full squat.',
      'Stand to complete.',
    ],
    tips: ['More demanding than hang power clean. Ensure solid front rack position.'],
  },
  'clean-and-jerk': {
    how: [
      'Clean the bar from the floor to the front rack.',
      'Dip at the knees (small, fast dip), then drive explosively overhead.',
      'Split your feet front and back to receive the bar overhead (split jerk) or drop into a quarter squat (push jerk).',
      'Recover to standing with the bar locked out overhead.',
    ],
    tips: ['The two lifts should feel like one continuous effort. Speed under the bar is key.'],
  },
  'power-snatch': {
    how: [
      'Wide grip (snatch grip), set up like the deadlift.',
      'First pull from floor, then explosive second pull.',
      'Receive the bar overhead in a partial squat with arms locked out.',
    ],
    tips: ['Requires excellent shoulder stability. The snatch grip is much wider than the clean.'],
  },
  'hang-power-snatch': {
    how: [
      'Start with bar at hip height, snatch-width grip.',
      'Slight hinge, then explosive hip drive.',
      'Receive bar overhead in partial squat with arms locked.',
    ],
    tips: ['Good drill for learning the second pull timing.'],
  },
  'squat-snatch': {
    how: [
      'Full snatch from the floor with a wide grip.',
      'Receive the bar overhead in a full squat.',
      'Stand to complete the lift.',
    ],
    tips: ['The most technically demanding Olympic lift. Build shoulder and hip mobility first.'],
  },
  'hang-snatch': {
    how: [
      'Wide (snatch) grip, bar at hip or knee height.',
      'Drive the hips into the bar explosively.',
      'Receive in a full squat with arms locked overhead.',
    ],
    tips: ['Focus on pulling yourself under the bar, not pushing it up.'],
  },
  'split-jerk': {
    how: [
      'Front rack position. Dip and drive the bar overhead.',
      'Split your feet — front foot forward, back foot back — to receive the bar in a lunge position.',
      'Recover by bringing front foot back, then back foot forward.',
    ],
    tips: ['The split should be even — back knee over the back foot.'],
  },
  'push-jerk': {
    how: [
      'Front rack. Dip and drive explosively.',
      'Press the bar overhead while dropping into a slight squat to receive it.',
      'Stand to finish.',
    ],
    tips: ['The bar should feel "weightless" at the top of the drive — that is when you drop under it.'],
  },
  'overhead-squat': {
    how: [
      'Clean and press or snatch a barbell to an overhead, wide-grip position.',
      'Feet shoulder-width or slightly wider, toes out.',
      'Squat while keeping the bar directly over your mid-foot.',
    ],
    tips: ['Reveals mobility limitations in ankles, hips, and thoracic spine.'],
  },
  'clean-pull': {
    how: [
      'Set up like a deadlift. Drive the bar off the floor with clean mechanics.',
      'Continue the pull through the hips and onto the toes — but do NOT catch the bar.',
      'Lower the bar back to the floor.',
    ],
    tips: ['Trains the clean pull pattern with heavier loads.'],
  },
  'snatch-pull': {
    how: [
      'Wide (snatch) grip, same mechanics as the clean pull.',
      'Drive from the floor, extend onto the toes, shrug — but do NOT catch.',
    ],
    tips: ['Load can exceed your snatch max. Focus on bar speed through the hips.'],
  },
  'muscle-snatch': {
    how: [
      'Wide grip, bar at hip height.',
      'Explosively extend the hips, then pull the bar up and over in one continuous press-out.',
      'No dropping under the bar — the arms finish the lift.',
    ],
    tips: ['Great drill for teaching the third pull (pressing yourself under). Very shoulder-demanding.'],
  },
  'snatch-balance': {
    how: [
      'Bar on your back in a snatch grip.',
      'Dip and drive the bar upward, then drop into a full squat while pressing the bar overhead.',
      'Stand with bar locked out.',
    ],
    tips: ['This drill trains speed under the bar in the receiving position.'],
  },
