...
export const DEFAULT_EXERCISES: Exercise[] = [
  ...
  { id: 'bird-dog', name: 'Bird Dog', category: 'Core', defaultRestSeconds: 30, muscleGroups: ['Core', 'Glutes', 'Erectors'], measureType: 'reps' },
  ...
  { id: 'pallof-press', name: 'Pallof Press', category: 'Core', defaultRestSeconds: 60, muscleGroups: ['Obliques', 'Core'] },
  ...
  { id: 'lateral-box-jump', name: 'Lateral Box Jump', category: 'Plyometrics', defaultRestSeconds: 90, muscleGroups: ['Glutes', 'Adductors', 'Calves'], measureType: 'reps' },
  { id: 'single-leg-hop', name: 'Single Leg Hop', category: 'Plyometrics', defaultRestSeconds: 90, muscleGroups: ['Quads', 'Glutes', 'Calves'], measureType: 'reps' },
  { id: 'hurdle-hop', name: 'Hurdle Hop', category: 'Plyometrics', defaultRestSeconds: 90, muscleGroups: ['Quads', 'Glutes', 'Calves'], measureType: 'reps' },
  { id: 'skater-jump', name: 'Skater Jump', category: 'Plyometrics', defaultRestSeconds: 60, muscleGroups: ['Glutes', 'Adductors', 'Calves'], measureType: 'reps' },
  { id: 'bounding', name: 'Bounding', category: 'Plyometrics', defaultRestSeconds: 90, muscleGroups: ['Hamstrings', 'Glutes', 'Calves'], measureType: 'reps' },

  // Speed
  { id: 'sprint', name: 'Sprint', category: 'Speed', defaultRestSeconds: 120, muscleGroups: ['Quads', 'Hamstrings', 'Calves'] },
  ...
  // Eccentric — injury prevention
  { id: 'eccentric-nordic', name: 'Eccentric Nordic Curl', category: 'Eccentric', defaultRestSeconds: 120, muscleGroups: ['Hamstrings'], suggestedRir: 2 },
  ...
  // Warmup — hidden from exercise library, used internally by programme sessions
